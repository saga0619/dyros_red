/* Produced by CVXGEN, 2018-12-11 02:48:55 -0500.  */
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 60) && (mxGetN(xm) == 60))) {
      printf("H must be size (60,60), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 1) && (mxGetN(xm) == 1))) {
      printf("f must be size (1,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 60) && (mxGetN(xm) == 1))) {
      printf("g must be size (60,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  if (xm == NULL) {
    ...
    if (!((mxGetM(xm) == 60) && (mxGetN(xm) == 1))) {
      printf("r must be size (60,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
  ...
  *mxGetPr(xm) = work.converged;
  ...
  xm = mxCreateDoubleMatrix(60, 1, mxREAL);
  mxSetField(plhs[0], 0, "P", xm);
  dest = mxGetPr(xm);
  src = vars.P;
  for (i = 0; i < 60; i++) {
    *dest++ = *src++;
